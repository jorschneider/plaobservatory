...
Robotics research: start with [Chinese autonomy: doctrine, technology and deployment](research/autonomy/README.md), including an authority-aware doctrine sourcebook, ten technical examples and an analyst collection queue. [Task-specific deployment economics](research/industrial-base/task-economics/README.md) contains four sourced cases, a cost-per-accepted-task method, a runnable ledger calculator and a workcell evidence request. The [relationship pilot](research/industrial-base/relationship-method.md) covers the wider supplier evidence.
