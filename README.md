...
Robotics research: start with the [military robotics ecosystem guide](research/military-robotics/README.md), which connects nine named platform cases, six institutional records and three procurement records to doctrine, industrial relationships and operating work. The guide also includes [issuer revenue and repeat-sales evidence](research/military-robotics/scale.md), [cases that test the industrial thesis](research/military-robotics/thesis-tests.md), [three software/component lineage records](research/military-robotics/lineage.md) and [two distinct qualification cases](research/military-robotics/assurance.md). Its [comparison index](research/military-robotics/case-index.json) links the ground, air and maritime sourcebooks. Continue with [Chinese autonomy: doctrine, technology and deployment](research/autonomy/README.md) and the [worked-case analyst brief](research/autonomy/cases/README.md). The package includes eight doctrine sources, ten technical examples, pinned Unitree dependencies, human-authority and passenger-aviation cases, and an evidence-linked collection queue. [Task-specific deployment economics](research/industrial-base/task-economics/README.md) contains four sourced cases, a cost-per-accepted-task method, a runnable ledger calculator and a workcell evidence request. The [relationship pilot](research/industrial-base/relationship-method.md) covers the wider supplier evidence, including updated Shuguang ownership and Jingpin software progress.
