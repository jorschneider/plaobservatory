...
Xinhua's **5 February 2025** announcement says the revised **《军队装备科研条例》** took effect **1 March 2025**. Its description covers research planning and approval, project classification, quality/cost controls, acceptance assessment and results management. This establishes an officially announced governance framework for equipment research. The full regulation was not reviewed; the announcement does not supply robotics-specific acceptance criteria, delegation of purchasing authority or autonomous-system control rules. It should not be renamed an equipment-procurement regulation. [Original announcement, final substantive paragraph](https://www.xinhuanet.com/politics/leaders/20250205/6ff4059d89294dd6abd74615805819df/c.html).

Read this alongside the [institutional map](institutions.md) and [doctrine sourcebook](../autonomy/doctrine.md). For each future project, keep the research sponsor, contracting buyer, supplier, operator and acceptance authority as separate roles until a source connects them.
