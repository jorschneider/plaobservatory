...
- Zhang Qingmin. 2008. ‘Continuities and Changes in China’s Negotiating Behavior.’ In China’s ‘New’ Diplomacy: Tactical or Fundamental Change?, edited by Pauline Kerr, Stuart Harris, and Qin Yaqing, 153–175. Palgrave Macmillan, New York. [Citation/source](https://doi.org/10.1007/978-0-230-61692-9_8). **Public route identified.** [Access route](https://www.jura.fu-berlin.de/fachbereich/einrichtungen/oeffentliches-recht/lehrende/bolewskiw/dokumente/7__Culture_Language/Kerr_China_New_Diplomacy_One.pdf). Type: scholarly book chapter.

- Xia, Yafeng. 2006. Negotiating with the Enemy: U.S.-China Talks during the Cold War, 1949–1972. Indiana University Press. 352 pp. [Citation/source](https://iupress.org/9780253112378/negotiating-with-the-enemy/). **Copy useful.** [Access route](https://iupress.org/9780253112378/negotiating-with-the-enemy/). Type: scholarly monograph.

- Wilhelm, Alfred D., Jr. 1994. The Chinese at the Negotiating Table: Style and Characteristics. Washington, DC: National Defense University Press. xxxiii + 281 pp. [Citation/source](https://catalog.freelibrary.org/Record/1985071). **Copy useful.** [Access route](https://books.google.com/books?id=40azDouR8voC). Type: government-published research monograph.

- 劉必榮（Bih-Rong Liu）. 1992. 〈中共談判行為研究：不同個案的比較分析〉[platform English title: ‘Communist Chinese Negotiating Behavior’]. 《東吳政治學報》1（3月）：123–203. [Citation/source](https://toaj.stpi.niar.org.tw/index/journal/volume/article/4b1141f992d0e7290192e5a1b28e115e). **Public route identified.** [Access route](https://toaj.stpi.niar.org.tw/index/journal/volume/article/4b1141f992d0e7290192e5a1b28e115e). Type: scholarly journal article.
...
- Fang, Tony, Verner Worm, and Rosalie L. Tung. 2008. ‘Changing success and failure factors in business negotiations with the PRC.’ International Business Review 17 (2): 159–169. [Citation/source](https://doi.org/10.1016/j.ibusrev.2008.02.012). **Public route identified.** [Access route](https://www.researchgate.net/publication/227417301_Changing_success_and_failure_factors_in_business_negotiations_with_the_PRC). Type: scholarly journal article; business negotiations only.

## Institutions, audiences and source methods

[Detailed register](institutions-and-methods-candidates.json)

- Jakobson, Linda, and Ryan Manuel. 2016. ‘How are Foreign Policy Decisions Made in China?’ Asia & the Pacific Policy Studies 3(1): 101–110. [Citation/source](https://doi.org/10.1002/app5.121). **Public route identified.** [Access route](https://onlinelibrary.wiley.com/doi/10.1002/app5.121). Type: scholarly journal article.
...
- Loh, Dylan M. H. 2018 [issue year; accepted April 2019]. “Diplomatic Control, Foreign Policy, and Change under Xi Jinping: A Field-Theoretic Account.” *Journal of Current Chinese Affairs* 47(3):111–145. **Complete published article, notes, references, table and figure read, September 15.** [Publisher PDF](https://journals.sub.uni-hamburg.de/giga/jcca/article/viewFile/1183/1183-1221-1-PB.pdf); [critical reading and ASEAN source checks](readings/loh-diplomatic-control.md). Type: scholarly article with original interviews and observation; not a measured study of concession flexibility.

- Taylor, Monique, and Jeremy Garlick. 2025. ‘“Flexible” versus “fragmented” authoritarianism: evidence from Chinese foreign policy during the Xi Jinping era.’ Australian Journal of International Affairs 79(2): 189–208. [Citation/source](https://doi.org/10.1080/10357718.2024.2437035). **Complete published article and references read, September 15.** [Lawful repository](https://zenodo.org/records/15016796); [critical reading and primary audit](readings/taylor-garlick-flexible-authoritarianism.md). Type: scholarly journal article; CC BY 4.0.

- Weiss, Jessica Chen, and Allan Dafoe. 2019. ‘Authoritarian Audiences, Rhetoric, and Propaganda in International Crises: Evidence from China.’ International Studies Quarterly 63(4): 963–973. [Citation/source](https://doi.org/10.1093/isq/sqz059). **Public route identified.** [Access route](https://www.jessicachenweiss.com/uploads/3/0/6/3/30636001/19-01-24-elite-statements-isq-ca.pdf). Type: scholarly journal article.

- Mokry, Sabine. 2024. ‘China’s foreign policy rhetoric between orchestration and cacophony.’ The Pacific Review 37(2): 360–387. [Citation/source](https://doi.org/10.1080/09512748.2023.2175895). **Public route identified.** [Access route](https://www.tandfonline.com/doi/full/10.1080/09512748.2023.2175895). Type: scholarly journal article.

- Mokry, Sabine. 2022. ‘What is Lost in Translation? Differences between Chinese Foreign Policy Statements and Their Official English Translations.’ Foreign Policy Analysis 18(3): orac012. [Citation/source](https://doi.org/10.1093/fpa/orac012). **Public route identified.** [Access route](https://academic.oup.com/fpa/article/18/3/orac012/6575815). Type: scholarly journal article.

## Trade, legal learning and economic bargaining

[Detailed register](trade-candidates.json)

- Pearson, Margaret M. 2001. ‘The Case of China's Accession to GATT/WTO.’ In The Making of Chinese Foreign and Security Policy in the Era of Reform, edited by David M. Lampton, 337–370. Stanford University Press. [Citation/source](https://doi.org/10.1515/9780804764490-014). **Copy useful.** [Access route](https://www.degruyterbrill.com/document/doi/10.1515/9780804764490-014/html). Type: scholarly book chapter.

- Zeng, Ka. 2004. Trade Threats, Trade Wars: Bargaining, Retaliation, and American Coercive Diplomacy. University of Michigan Press. [Citation/source](https://doi.org/10.3998/mpub.17690). **Copy useful.** [Access route](https://press.umich.edu/Books/T/Trade-Threats-Trade-Wars). Type: scholarly monograph.

- Blustein, Paul. 2019. Schism: China, America and the Fracturing of the Global Trading System. Centre for International Governance Innovation. [Citation/source](https://www.cigionline.org/publications/schism-china-america-and-fracturing-global-trading-system/). **Copy useful.** [Access route](https://www.cigionline.org/publications/schism-china-america-and-fracturing-global-trading-system/). Type: reported analytical book; not a peer-reviewed journal article.

- Shaffer, Gregory, and Henry Gao. 2018. ‘China’s Rise: How It Took On the U.S. at the WTO.’ University of Illinois Law Review 2018(1):115–184. [Citation/source](https://illinoislawreview.org/print/vol-2018-no-1/chinas-rise/). **Public route identified.** [Access route](https://www.illinoislawreview.org/wp-content/uploads/2018/01/Shaffer.pdf). Type: scholarly law-review article.

- Gao, Henry. 2022. “China’s Changing Perspective on the WTO: From Aspiration, Assimilation to Alienation.” World Trade Review 21(3): 342–358. [Citation/source](https://doi.org/10.1017/S1474745622000088). **Public route identified.** [Access route](https://ink.library.smu.edu.sg/sol_research/3996/). Type: scholarly journal article.

- Hopewell, Kristen. 2020. Clash of Powers: US-China Rivalry in Global Trade Governance. Cambridge University Press. [Citation/source](https://doi.org/10.1017/9781108877015). **Copy useful.** [Access route](https://www.cambridge.org/core/books/clash-of-powers/introduction/3F621409B06FCD84ECA8D92956CB65D2). Type: scholarly monograph.

- Liang, Wei, and Ka Zeng. 2023. “China and the BRICS in WTO E-Commerce and Fisheries Negotiations: Competition and Convergence.” In China and the WTO: A Twenty-Year Assessment, edited by Henry Gao, Damian Raess and Ka Zeng, 227–251. Cambridge University Press. [Citation/source](https://doi.org/10.1017/9781009291804.015). **Public route identified.** [Access route](https://www.cambridge.org/core/books/china-and-the-wto/china-and-the-brics-in-wto-ecommerce-and-fisheries-negotiations/B2CE3A3232BDDED813E50189F3F0C7B5). Type: scholarly book chapter.
...
[Detailed register](security-candidates.json)

- Johnston, Alastair Iain. 2013. ‘How New and Assertive Is China's New Assertiveness?’ International Security 37(4), Spring: 7–48. [Citation/source](https://doi.org/10.1162/ISEC_a_00115). **Public route identified.** [Access route](https://www.belfercenter.org/sites/default/files/pantheon_files/files/publication/IS3704_pp007-048.pdf). Type: scholarly journal article.

- Fravel, M. Taylor. 2005. ‘Regime Insecurity and International Cooperation: Explaining China's Compromises in Territorial Disputes.’ International Security 30(2), Fall: 46–83. [Citation/source](https://doi.org/10.1162/016228805775124534). **Complete published article and all 125 notes read, 10 September.** [Critical memo and primary audit](readings/fravel-compromise-and-1989-records.md). [Access route](https://www.taylorfravel.com/documents/research/fravel.2005.IS.regime.insecurity.pdf). Type: scholarly journal article.

- Iwashita, Akihiro. 2004. A 4,000 Kilometer Journey Along the Sino-Russian Border. Slavic Eurasian Studies 3. Sapporo: Slavic Research Center, Hokkaido University. xiv + 210 pp. [Citation/source](https://src-h.slav.hokudai.ac.jp/coe21/publish/no3_ses/contents.html). **Substantial complete-chapter reading, 10 September:** preface, introduction, Chapters 1/3/6, conclusion and reference inventory; Chapters 2/4/5 and index unread. [Case and limits](../cases/russia-border-settlement.md). [Access route](https://src-h.slav.hokudai.ac.jp/coe21/publish/no3_ses/contents.html). Type: scholarly monograph.

- Mastro, Oriana Skylar. 2019. The Costs of Conversation: Obstacles to Peace Talks in Wartime. Ithaca: Cornell University Press. 216 pp. [Citation/source](https://doi.org/10.7591/cornell/9781501732201.001.0001). **Copy useful.** [Access route](https://academic.oup.com/cornell-scholarship-online/book/61096). Type: scholarly monograph.

- Garver, John. 2011. ‘The Unresolved Sino–Indian Border Dispute: An Interpretation.’ China Report 47(2): 99–113. [Citation/source](https://doi.org/10.1177/000944551104700204). **Copy useful.** [Access route](https://journals.sagepub.com/doi/10.1177/000944551104700204). Type: scholarly journal article.

- Mastro, Oriana Skylar. 2011. ‘Signaling and Military Provocation in Chinese National Security Strategy: A Closer Look at the Impeccable Incident.’ Journal of Strategic Studies 34(2): 219–244. [Citation/source](https://doi.org/10.1080/01402390.2011.559025). **Public route identified.** [Access route](https://www.researchgate.net/publication/233359857_Signaling_and_Military_Provocation_in_Chinese_National_Security_Strategy_A_Closer_Look_at_the_Impeccable_Incident). Type: scholarly journal article.

- Chubb, Andrew. 2021. ‘PRC Assertiveness in the South China Sea: Measuring Continuity and Change, 1970–2015.’ International Security 45(3), Winter 2020/21: 79–121. [Citation/source](https://doi.org/10.1162/isec_a_00400). **Public route identified.** [Access route](https://eprints.lancs.ac.uk/151535/1/Chubb_China_s_assertiveness_AUTHOR_ACCEPTED_COPY.pdf). Type: scholarly journal article.
...
## Additional Phase One scholarship and recent crisis research

These case-specific additions sit outside the original 37-work screening population. The reading ledger distinguishes two complete scholarly readings from the selected crisis report.

- Wu, Cathy Xuauxuan (author name as printed by the publisher). 2024. “A Bargaining Theory of US–China Economic Rivalry: Differentiating the Trade and Technology Wars.” *The Chinese Journal of International Politics* 17(4):323–345. [Publisher article](https://academic.oup.com/cjip/article/17/4/323/7718347), DOI 10.1093/cjip/poae017. Complete substantive HTML and all 106 notes read; no complete PDF reading claimed. [Critical reading](readings/phase-one-bargaining-theory.md) and [version register](../sources/phase-one-bargaining-theory-register.json).
...
## Additional climate-process and policy readings

- Högl, Maximilian. 2019. “Kooperationsfaktoren in den Klimaverhandlungen: Eine vergleichende Analyse der Klimagipfel in Kopenhagen 2009 und in Paris 2015.” *Zeitschrift für Außen- und Sicherheitspolitik* 12:357–378. [Publisher](https://link.springer.com/article/10.1007/s12399-019-00782-9). Complete 22-page article, notes, references and three figures. The 2020 erratum concerns open-access licensing. [Critical reading](readings/climate-change-mechanisms.md).
- Williams, Lisa. 2014. *China's Climate Change Policies: Actors and Drivers*. Lowy Institute Analysis, July. [Institutional PDF](https://www.files.ethz.ch/isn/182715/chinas-climate-change-policies.pdf). Complete 31-page policy report, all 104 notes, ten figures and two tables. Separate from scholarly article count. [Critical reading](readings/climate-change-mechanisms.md).
- Yang, Chi-Jen, and Robert B. Jackson. 2013. “China's synthetic natural gas revolution.” *Nature Climate Change* 3:852–854. [Publisher](https://www.nature.com/articles/nclimate1988). Complete technical commentary, all 15 references, table and two figures. Separate technical context; modeled consequences are not negotiation evidence. [Source record](../manuscript/development/climate-policy-boundaries-register.json).
